package xyz.sigmalab.xtool.elasticreporter.v1.kamon.lego

import xyz.sigmalab.xtool.elasticreporter.v1.common.{GroupedMetrics, ReportContext}
import kamon.metric._

case class GroupedMetric(
    val id: String,
    val snapshot: MetricsSnapshot
) extends xyz.sigmalab.xtool.elasticreporter.v1.common.GroupedMetrics {
